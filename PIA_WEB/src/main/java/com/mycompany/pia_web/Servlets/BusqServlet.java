 ...
 * @author migue
 */
@WebServlet(name = "BusqServlet", urlPatterns = {"/BusqServlet"})
public class BusqServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BusqServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BusqServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Conexion conn =  new Conexion();
            ...
            List listaPublicaciones =pDao.BusqP(Busq); // Implementa este método según tu lógica
